...
const InteriorScreen = ({ selectedClass, onBack }) => {
    ...
    return (
      <div className="p-6 text-center">
        ...
        <p className="text-red-500">
          Floor plan data for floor {floorNumber} is not available.
        </p>
      </div>
    );
  }
  ...
  const entranceId = selectedEntrance
    ? floor.entranceIdMap[selectedEntrance]
    : null; // e.g., "north-entrance"
    ...
    <div className="p-4 md:p-6">
      ...
      <div className="text-center mb-6">
        ...
        <p className="text-lg text-gray-600">
          Navigating to Room {selectedClass.room}
        </p>
      </div>
      ...
      {!selectedEntrance ? (
        ...
        <div className="max-w-4xl mx-auto">
          <p className="text-center mb-4">
            Showing route from{" "}
            <span className="font-bold">{selectedEntrance}</span>.
            <button
          ...
          <div className="border rounded-lg overflow-auto h-[60vh] bg-gray-100 cursor-grab active:cursor-grabbing flex justify-center items-center">
            <div
              ...
              style={{
                ...
                width: rotation % 180 !== 0 ? "81vh" : "auto",
