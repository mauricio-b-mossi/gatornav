...
const HomeScreen = ({ onSearch }) => {
  ...
  useEffect(() => {
    const storedSearches = JSON.parse(
      localStorage.getItem("gatornav_recent") || "[]"
    );
  ...
  return (
    <div className="p-6 md:p-8 text-center">
      ...
      <p className="text-lg text-gray-600 mb-8">
        Find your classroom, stress-free.
      </p>
      ...
      <div className="max-w-md mx-auto">
        <div className="flex flex-col sm:flex-row gap-2">
          <input
            ...
            className="grow w-full px-4 py-3 text-lg border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition"
          />
          <button
            onClick={handleSearch}
            className="bg-blue-600 text-white font-bold px-6 py-3 rounded-lg hover:bg-blue-600 transition-all duration-300 transform hover:scale-105 shadow-md"
          >
            Search
          </button>
        </div>
